...
public class IssuesPost extends AppCompatActivity {
    ...
    String name, email,dp, uid, house_number;
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot ds: snapshot.getChildren()){
                    name = ""+ ds.child("tenant_name").getValue();
                    email = ""+ ds.child("email").getValue();
                    house_number = ""+ ds.child("house_number").getValue();
    ...
    private void uploadData(final String title, final String description, String uri) {
        ...
        pd.setMessage("Posting your issue...");
        pd.show();
                    ...
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            if(uriTask.isSuccessful()){
                                ...
                                hashMap.put("uDp", dp);
                                hashMap.put("uHouse", house_number);
